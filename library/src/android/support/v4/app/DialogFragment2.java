...
public class DialogFragment2 extends DialogFragment
{
     ...
     * then committing the transaction whilst allowing state loss.<br>
     * 
     * I would recommend you use {@link #show(FragmentTransaction, String)} most
     * of the time but this is for dialogs you reallly don't care about.
     * (Debug/Tracking/Adverts etc.)
     * 
     * @param transaction
     ...
     * fragment to it with the given tag, and committing it without careing
     * about state. This does <em>not</em> add the transaction to the back
     * stack. When the fragment is dismissed, a new transaction will be executed
     * to remove it from the activity.<br>
     * 
     * I would recommend you use {@link #show(FragmentManager, String)} most of
     * the time but this is for dialogs you reallly don't care about.
     * (Debug/Tracking/Adverts etc.)
     * 
     * 
     * @param manager
